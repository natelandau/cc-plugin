...
description: Use when writing, editing, or reviewing Python code (.py files), including pytest tests and uv-based dependency management. Covers code style, Google-format docstrings, testing conventions, and package management.
paths: "**/*.py"
---

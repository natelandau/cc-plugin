...
# NOTE: not drift-guarded — emitters/STAGE_EMITTERS are recall-specific (sessionstart/end/precompact).
"""
...
def emit_precompact(blocking: Decision | None, contexts: list[str]) -> NoReturn:  # noqa: ARG001
    """PreCompact: side-effect only (spawn the sweep); never block compaction."""
    sys.exit(0)

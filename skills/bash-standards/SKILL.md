---
name: bash-standards
description: Use when writing, editing, or reviewing Bash/shell scripts (.sh files, shebang #!/usr/bin/env bash) or when writing Bash commands in the Bash tool. Covers quoting, error handling, comment conventions, and rules for echo separator strings.
paths: ["**/*.sh", "**/*.bash"]
---

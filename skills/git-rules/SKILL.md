---
name: git-rules
description: Use when running git commands, writing commit messages, or working with git worktrees. Covers commit message format, worktree setup for Python/uv projects, and safety rules around push/merge/force-push.
---
